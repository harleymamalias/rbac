            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 light:bg-gray-800">
                    <tr>
                        ...
                        <th rowspan="2" class="border p-2">Update Permissions</th>
                    </tr>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!-- Update Permissions Button and Modal -->
                        <td class="border p-2 flex items-center justify-center">
                            <button onclick="openModal({{ $user->id }})"
                                class="bg-blue-500 text-white px-4 py-2 rounded flex items-center space-x-2">
                                <!-- Eye Icon -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 8.5a3.5 3.5 0 100 7 3.5 3.5 0 000-7zm0 0C5.5 8.5 2 12 2 12s3.5 3.5 10 3.5 10-3.5 10-3.5-3.5-3.5-10-3.5z" />
                                </svg>
                            ...
                            <!-- Modal -->
                            <div id="modal-{{ $user->id }}" class="hidden fixed inset-0 z-10 overflow-y-auto"
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <h3 class="text-lg font-medium leading-6 text-gray-800 capitalize dark:text-white"
                                            id="modal-title">
                                            Check Permissions for User #{{ $user->id }}
                                        </h3>
                                        ...
                                        <form action="{{ route('assign.permissions', $user->id) }}" method="POST">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <label class="block mt-3 flex items-center text-white">
