...
<div class="bg-white dark:bg-gray-900">
    <div class="flex justify-center h-screen">
        <div class="hidden bg-cover lg:block lg:w-2/3"
            style="background-image: url(https://codesource.io/wp-content/uploads/2019/12/laravel.png)">
            <div class="flex items-center h-full px-20 bg-gray-900 bg-opacity-30">
                <div>
                    <h2 class="text-2xl font-bold text-white sm:text-3xl">Role Based Access Control</h2>
            ...
            <div class="flex-1">
                <div class="text-center">
                    <div class="flex justify-center mx-auto">
                        <img class="w-auto h-7 sm:h-8" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Laravel.svg/1200px-Laravel.svg.png" alt="">
                    </div>
                ...
                <div class="mt-8">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mt-6">
                            <button type="submit"
                                class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-300 transform bg-[#f9533b] rounded-lg hover:bg-[#f94d2d] focus:outline-none focus:bg-[#f94d2d] focus:ring focus:ring-[#f9533b] focus:ring-opacity-50">
                                Sign in
                            </button>
                    ...
                    <p class="mt-6 text-sm text-center text-gray-400">Don't have an account yet? <a
                            href="{{ route('register') }}"
                            class="text-[#f9533b] focus:outline-none focus:underline hover:underline">Sign up</a>.</p>
                </div>
                <div class="mt-6 justify-center flex">
                    <div class="flex items-center gap-3 sm:gap-x-5">
                        <button
                            class="bg-white dark:bg-gray-900 dark:border-gray-700 dark:hover:bg-gray-800 rounded-lg hover:bg-gray-100 duration-300 transition-colors border px-8 py-2.5">
                            <svg class="w-5 h-5 sm:h-6 sm:w-6" viewBox="0 0 24 24" fill="none"
                        ...
                        <button
                            class="bg-[#1877F2] rounded-lg hover:bg-[#1877F2]/80 duration-300 transition-colors border border-transparent px-8 py-2.5">
                            <svg class="w-5 h-5 sm:h-6 sm:w-6" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button
                            class="bg-black rounded-lg hover:bg-black/80 duration-300 transition-colors border border-transparent px-8 py-2.5">
                            <svg class="w-5 h-5 sm:h-6 sm:w-6" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
